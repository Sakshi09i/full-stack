<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:shaikh@gmail.com"><i class="fas fa-envelope"></i>Vishal7860@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>bhumika & vishal</span> | all rights reserved!</div>
